        ...
        <div class="label-and-controls-container">
          ...
          <div class="cl-calendar-input-control">
            <input id="cl-date-input"
                   type="date"
                   name="date"
                   aria-labelledby="cl-calendar-label">
      
              <div class="input-ui-override" cl-element="input" aria-hidden="true">
                <span class="selected-date-value"></span>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                     class="calendar-icon" aria-hidden="true">
