...
export default class SysConsentComponent extends WcControlledElement {
  ...
  connectedCallback() {
        ...
        <div class="label-with-input-container">
          <div class="input-with-tooltip">
            <label class="checkmark-container">
              <input type="checkbox"
                     name="fname"
                     aria-labelledby="cl-consent-label">
    ...
    this.observeProps((prev, next) => {
      ...
      const checkboxInput = this.getRootElement().querySelector('input[type="checkbox"]');
      if (checkboxInput) {
        checkboxInput.setAttribute('aria-required', String(!!next.control?.validation?.required));
      }
